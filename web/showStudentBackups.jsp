    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#batchDelete").click(function() {
                ...
                $("[name=studentId]:checked").each(function (index, account) {
                    var sid = $(accout).val();
                    // push将数据放入数组中
                    sidsArr.push(sid);
                });
                if (sidsArr.length == 0) {
                    ...
                    var string = sidsArr.join();
                    // window.location.href = "studentServlet?flag=deleteStudent&studentId=" + string;
                }
            });
        });
    </script>
...
<form action="studentServlet" method="post">
    <input type="hidden" name="flag" value="batchDelete">
    <%--  学生信息展示表头  --%>
    <table border="1" cellpadding="0" cellspacing="0" align="center" width="600px">
        ...
        <c:forEach var="student" items="${studentList}">
            <tr align="center">
                ...
                <td>
                    <a href="studentServlet?flag=deleteStudent&studentId=${student.sid}">删除</a>
                </td>
            </tr>
        </c:forEach>
    </table>
    <%--   批量删除   --%>
    <div id="buttonsBox">
        <input id="batchDelete" type="submit" value="批量删除" align="left">
